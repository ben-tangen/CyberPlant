...
| 2026-04-25 | J2 | Enemy variations (3-5) + tuning | Judah | All enemy assests complete | J3, T13 | Build from base enemy scene inheritance. |
| 2026-04-27 | T08 / B3 | Weapon system (switching + attack behaviors) | Ben | Added inventory-based weapon selection with 1-4 slot switching, weapon catalog definitions, shop purchases, and weapon-specific damage/cooldown/range behavior wired into the player attack controller. | T12, T13 | Reconstructed from current code and recent level/weapon logic commit |
| 2026-04-28 | T07 / T12 / T13 | Movement, boss, and balance pass | Ben / Team | Tuned player movement and damage feedback, rebalanced weapon timing and enemy pressure, added telegraphed boss phase behavior, and reshaped Level02, Level03, and Home for a clearer progression ramp. | T14 | Audio assets are still missing, so sound effects and background music remain a follow-up |
