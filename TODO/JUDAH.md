...
| J3 | Boss prototype | Done | J2, B3 | T13 | Define phase hooks early to avoid rework. |
| J4 | Structure Design | Done | Unblocked | Level Building | Build structures such as walls, floors, ceilings, etc. for level building. |
